...
import com.tol.tenderwork.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.tol.tenderwork.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.tol.tenderwork.repository.search")
